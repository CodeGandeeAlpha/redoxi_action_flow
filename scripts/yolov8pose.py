...
class YOLOv8pose:
    ...
    def draw_detections(self, img, box, score, class_id, pose):
        """
        ...
        Args:
            ...
            pose: Keypoints for the detected object.
    ...
    def postprocess(self, input_image, output):
        ...
        for i in indices:
            ...
            self.draw_detections(input_image, box, score, class_id, pose)
