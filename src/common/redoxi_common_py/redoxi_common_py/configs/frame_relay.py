...
__all__ = (
    [
        "FrameRelayNodeConfig",
        "FrameRelayNodeInitConfig",
        "FrameRelayNodeRuntimeConfig",
    ]
    + portCfg.__all__
    + baseNodeCfg.__all__
)
...
@define(kw_only=True)
class FrameRelayNodeInitConfig(baseNodeCfg.BaseRosNodeInitConfig):
...
@define(kw_only=True)
class FrameRelayNodeRuntimeConfig(baseNodeCfg.BaseRosNodeRuntimeConfig):
    enable_blocking_mode: bool = field(default=False)
    enable_debug_topics: bool = field(default=False)


@define(kw_only=True)
class FrameRelayNodeConfig(baseNodeCfg.BaseRosNodeConfig):
    init_config: FrameRelayNodeInitConfig = field(factory=FrameRelayNodeInitConfig)
    runtime_config: FrameRelayNodeRuntimeConfig = field(
        factory=FrameRelayNodeRuntimeConfig
    )
