...
const auto fn_model = "/3d/chengxiao/code/ultralytics/test_cx/models/yolov11-pose-with-headpts-dyn-bs1-decode_slim.onnx";
...
int main(int argc, char **argv)
{
    ...
    // set model path, and open model
    {
        ...
        params->set_string(cmkeys::ModelPath, fn_model);
    ...
    // infer with random data
    {
        ...
        double image_mean = 0.0;
        {
            ...
            // if batch size is not specified, set it to 1
