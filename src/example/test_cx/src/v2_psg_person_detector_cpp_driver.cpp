...
int main(int argc, char **argv)
{
    ...
    auto psg_detector_node = std::make_shared<rdx::PSGPersonDetectorCppDriver>("psg_person_detector_cpp_driver");

    //! Initialize the node with default configuration
    auto init_config = std::make_shared<rdx::PSGPersonDetectorCppDriver::InitConfig_t>();
    ...
    auto runtime_config = std::make_shared<rdx::PSGPersonDetectorCppDriver::RuntimeConfig_t>();
