...
int main(int argc, char **argv)
{
    ...
    auto node = std::make_shared<rdx::PSGPersonGenerator>("psg_person_generator");

    //! Initialize the node with default configuration
    auto init_config = std::make_shared<rdx::psg_person_generator::InitConfig>();
    ...
    auto runtime_config = std::make_shared<rdx::psg_person_generator::RuntimeConfig>();
