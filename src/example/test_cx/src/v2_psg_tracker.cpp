...
int main(int argc, char **argv)
{
    ...
    auto psg_tracker_node = std::make_shared<rdx::PSGTracker>("psg_tracker_node", options);

    //! Initialize the node with default configuration
    auto init_config = std::make_shared<rdx::PSGTracker::InitConfig_t>();
    ...
    auto runtime_config = std::make_shared<rdx::PSGTracker::RuntimeConfig_t>();
