...
int main(int argc, char **argv)
{
    ...
    auto node = std::make_shared<rdx::VideoReaderFromUrl>("video_source_from_url");

    //! Configure the node from parameters
    spdlog::info("Parsing initialization configuration from parameters...");
    auto init_config = std::make_shared<rdx::VideoReaderFromUrl::InitConfig_t>();
    ...
    auto runtime_config = std::make_shared<rdx::VideoReaderFromUrl::RuntimeConfig_t>();
...
void print_jsons()
{
    using InitConfig_t = rdx::VideoReaderFromUrl::InitConfig_t;
    using RuntimeConfig_t = rdx::VideoReaderFromUrl::RuntimeConfig_t;
    using DownstreamSpec_t = rdx::VideoReaderFromUrl::DownstreamSpec_t;
