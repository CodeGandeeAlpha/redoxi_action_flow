...
// const auto fn_model = fs::path(TEST_MODEL_DIR) / "yolov8n-pose-640.onnx";
// const auto fn_model = fs::path(TEST_MODEL_DIR) / "rknn" / "yolov8s-pose-pthq.rknn";
const fs::path fn_model = "/data/code/psf_ros2_ws/tmp/models/rknn/pose/small/yolov8s-pose-352x640-bs1-pthq.rknn";
...
int main(int argc, char **argv)
{
    ...
    // load model
    {
        ...
        params->set_string(cmkeys::DeviceType, cmdev::RKNPU);
