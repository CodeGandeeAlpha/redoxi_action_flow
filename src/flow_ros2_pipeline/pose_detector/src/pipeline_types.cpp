...
{
void PoseDetectorPipelineInitConfig::from_parameters(PoseDetectorPipeline *node)
{
...
void PoseDetectorPipelineRuntimeConfig::from_parameters(PoseDetectorPipeline *node)
{
