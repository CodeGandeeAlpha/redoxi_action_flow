...
class TrackerIn : public rclcpp::Node, public IStartStopProtocol
{
  public:
  ...
  public:
    ...
    using InitConfig = TrackerInInitConfig;
    using RuntimeConfig = TrackerInRuntimeConfig;
  ...
  protected:
    ...
    // impl data
    std::shared_ptr<TrackerInImpl> m_impl;
