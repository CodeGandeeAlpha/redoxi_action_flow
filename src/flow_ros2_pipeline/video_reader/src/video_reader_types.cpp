...
namespace FlowRos2Pipeline {
    void OpencvVideoReaderInitConfig::from_parameters(OpencvVideoReader* node) {
        ...
        RCLCPP_INFO(logger_, "[OpencvVideoReader] source_file: %s", this->source_file.c_str());
        RCLCPP_INFO(logger_, "[OpencvVideoReader] source_camera_index: %d", this->source_camera_index);
        RCLCPP_INFO(logger_, "[OpencvVideoReader] start_frame_number: %d", this->start_frame_number);
        RCLCPP_INFO(logger_, "[OpencvVideoReader] end_frame_number: %d", this->end_frame_number);
    }
    ...
    void OpencvVideoReaderRuntimeConfig::from_parameters(OpencvVideoReader* node) {
        ...
        RCLCPP_INFO(logger_, "[OpencvVideoReader] image_height: %d", this->image_height);
