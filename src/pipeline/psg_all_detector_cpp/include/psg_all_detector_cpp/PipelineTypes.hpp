...
using OutputPortModelType = redoxi_works::detection_ports::request_response::DetectionRequestOutputPort;
...
struct InitConfig : public common_nodes::StartStopNode::InitConfig_t {
    ...
    //! parse from node, the node must be exactly PSGDetectorNode, not its subclass
    template <typename Node_t>
    requires std::is_same_v<Node_t, PSGDetectorNode>
