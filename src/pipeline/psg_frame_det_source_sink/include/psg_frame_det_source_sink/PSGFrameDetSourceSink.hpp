 ...
 */
class PSGFrameDetSourceSink : public rclcpp::Node,
                              public IStartStopProtocol
{
  ...
  public:
    ...
    explicit PSGFrameDetSourceSink(const std::string &name, const rclcpp::NodeOptions &options = rclcpp::NodeOptions());
