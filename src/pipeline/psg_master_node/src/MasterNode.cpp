...
int PSGMasterNode::init(std::shared_ptr<InitConfig_t> config,
...
int PSGMasterNode::update_runtime_config(std::shared_ptr<RuntimeConfig_t> config)
{
...
void PSGMasterNode::_set_status_code(int status_code)
{
...
std::shared_ptr<PSGMasterNode::OutputPort_t>
    PSGMasterNode::_create_primary_output_port()
{
...
int PSGMasterNode::_declare_all_parameters()
{
