...
{
class PSGTrackerPipelineNode;

namespace psg_tracker_pipeline
{
...
using OutputPortModelType = AsyncGetTrackTargetsOutputPort;
...
//! The init config for PSGTrackerPipelineNode
struct InitConfig : public common_nodes::StartStopNode::InitConfig_t {
    ...
    requires std::is_same_v<Node_t, PSGTrackerPipelineNode>
...
//! The runtime config for PSGTrackerPipelineNode
