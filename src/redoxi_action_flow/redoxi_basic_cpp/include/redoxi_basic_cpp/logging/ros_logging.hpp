...
{
using logging::RDX_ASSERT_CHECK_TRUE;
using logging::RDX_ASSERT_REQUIRE_TRUE;
using logging::RDX_ASSERT_TRUE;
using logging::RDX_LOG_DEBUG;
using logging::RDX_LOG_ERROR;
using logging::RDX_LOG_FATAL;
using logging::RDX_LOG_INFO;
using logging::RDX_LOG_WARN;
using logging::RDX_RAISE_ERROR;
} // namespace redoxi_works

// for verbose output
#define RDX_INFO_VERBOSE redoxi_works::logging::RDX_LOG_INFO_0

// for development output
#define RDX_INFO_DEV redoxi_works::logging::RDX_LOG_INFO_1

// for development warning
#define RDX_WARN_DEV redoxi_works::logging::RDX_LOG_WARN_1

// for development debug
#define RDX_DEBUG_DEV redoxi_works::logging::RDX_LOG_DEBUG_1

// for production warning
#define RDX_WARN_PRODUCTION redoxi_works::logging::RDX_LOG_WARN_2

// for production output
#define RDX_INFO_PRODUCTION redoxi_works::logging::RDX_LOG_INFO_2
